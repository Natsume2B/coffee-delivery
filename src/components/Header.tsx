...
export function Header() {
  return (
    <header className='flex justify-between items-center mt-8 mb-24 '>
      ...
      <div className='flex gap-3 content-center'>
        ...
        <span className='text-product-yellow-dark bg-product-yellow-light p-2 rounded-md cursor-pointer'>
